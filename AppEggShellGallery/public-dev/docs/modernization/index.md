...
| **G** | PostgreSQL + Orleans 3.7 to 7.x upgrade | Not started. One coordinated workstream; full plan in [SQL Server to Postgres](./modernization/sql-server-to-postgres.md); see [Phased Plan](./modernization/phased-plan.md) Phase 3 / later. |
