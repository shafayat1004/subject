...
[view](./subject/views.md); the client's `EntityService` turns the server's SignalR push stream into a
...
`HttpService`; the server decodes it, runs session and [access-control](./subject/access-control.md)
...
- [Actions and transitions](./subject/actions-and-transitions.md)
- [Events and subscriptions](./subject/events-and-subscriptions.md)
- [Views](./subject/views.md)
