...
Related: [Android](./runbooks/android.md) | [iOS](./runbooks/ios.md) | [Web](./runbooks/web.md) | [Build and rebuild](./runbooks/build-rebuild.md) | [Architecture: Frontend](./architecture/frontend.md)
...
2. **Targeted rebuild** -- let the running watch recompile only the changed file(s). See [Build and rebuild](./runbooks/build-rebuild.md#targeted-recompile).
...
5. **Observe** -- screenshot and read logs (Tier 1), or `npm run observe -- snapshot` (Tier 2). See [Android](./runbooks/android.md), [iOS](./runbooks/ios.md), [Web](./runbooks/web.md), [Audit toolkit](./runbooks/audit-toolkit.md).
...
See also [Build and rebuild: mandatory restart conditions](./runbooks/build-rebuild.md#mandatory-restart).
