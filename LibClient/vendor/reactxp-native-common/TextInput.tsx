 ...
 *
 * EggShell patch: do not sync props.value into internal state while focused (iOS
 * keystrokes were wiped when parent state lagged onChangeText). Do not pass
 * defaultValue alongside value on the underlying RN TextInput.
 */
