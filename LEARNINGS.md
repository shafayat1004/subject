...
**Sidebar.Item pure-F# render:** hand-written `Item.fs` lost legacy style cascade; kept autogenerated `Item.Render.fs` with TapCapture → label/testId/MenuItem role until a faithful F# port lands.
